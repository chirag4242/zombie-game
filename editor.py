...
class Editor: 
    def __init__(self):
        ...
        self.support_line_surface = pygame.Surface((WIDTH_OF_WINDOW,HEIGHT_OF_WINDOW))
    ...
    def draw_grid_tiles(self):
        ...
        for column in range(columns + 1):
            ...
            pygame.draw.line(self.support_line_surface,LINE_COLOR,(x,0),(x,HEIGHT_OF_WINDOW))     
        for row in range(rows + 1):
            y = offset_vector.y + row * SIZE_OF_TILE 
            pygame.draw.line(self.support_line_surface,LINE_COLOR,(0,y),(WIDTH_OF_WINDOW,y))
